...
def translate(text, source_lang, target_lang):
    prompt = f"""
    Translate the following content from {source_lang} into {target_lang}. 
    The translated content should be keep the same meaning and style as the original content.
    """
